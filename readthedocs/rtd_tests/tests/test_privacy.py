...
# Private download tests
    ...
    def test_private_repo_downloading(self):
        ...
        r = self.client.get('/projects/django-kong/downloads/pdf/latest/')
        self.assertEqual(r.status_code, 200)
        self.assertEqual(r.headers['x-accel-redirect'][1], '/proxito/media/pdf/django-kong/latest/django-kong.pdf')
    ...
    def test_private_download_filename(self):
        ...
        self.assertEqual(r.status_code, 200)
        self.assertEqual(r.headers['x-accel-redirect'][1], '/proxito/media/pdf/django-kong/latest/django-kong.pdf')
        self.assertEqual(r.headers['content-disposition'][1], 'filename=django-kong-readthedocs-io-en-latest.pdf')

        r = self.client.get('/projects/django-kong/downloads/epub/latest/')
        self.assertEqual(r.status_code, 200)
        self.assertEqual(r.headers['x-accel-redirect'][1], '/proxito/media/epub/django-kong/latest/django-kong.epub')
        self.assertEqual(r.headers['content-disposition'][1], 'filename=django-kong-readthedocs-io-en-latest.epub')

        r = self.client.get('/projects/django-kong/downloads/htmlzip/latest/')
        self.assertEqual(r.status_code, 200)
        self.assertEqual(r.headers['x-accel-redirect'][1], '/proxito/media/htmlzip/django-kong/latest/django-kong.zip')
        self.assertEqual(r.headers['content-disposition'][1], 'filename=django-kong-readthedocs-io-en-latest.zip')
